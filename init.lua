...
vim.keymap.set('n', '<leader>ii', '<C-w><C-j>', { desc = 'Move focus to the lower window' })
vim.keymap.set('n', '<leader>mm', '<C-w><C-k>', { desc = 'Move focus to the upper window' })
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        extensions = {
          ...
          git_grep = {
            cwd = '%:h:p', -- Use the current directory as the working directory
            use_git_root = true, -- Search within the Git repository root
          },
        },
      }
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          ['<Tab-b>'] = cmp.mapping.scroll_docs(-4),
          ['<Tab-f>'] = cmp.mapping.scroll_docs(4),
